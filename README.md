...
1. **Breed Classification Models** – Separate models for cats and dogs that predict the breed from a given image.  
2. **Binary Classification Model** – A model that identifies whether a given image is of a cat or a dog.  

The project is implemented using deep learning with convolutional neural networks (CNNs).
...
```bash
git clone https://github.com/NobodydeBunny/Cat_Dog_breed_classifire_AI_model.git
cd Cat_Dog_breed_classifire_AI_model
